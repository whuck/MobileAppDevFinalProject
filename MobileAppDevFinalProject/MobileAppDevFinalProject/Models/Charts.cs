...
namespace MobileAppDevFinalProject.Models
{
	public class Charts : Application
	{
		...
		public void RotateThemAll(float x, float y, float z)
        {
			plotNode.Rotate(new Quaternion(x, y, z), TransformSpace.World);
        }
		public void Rotate(float toValue)
		{
			

			plotNode.Rotate(new Quaternion(toValue, 0, 0), TransformSpace.Local);
		}
		...
		{
			plotNode.Rotate(new Quaternion(0, 0,toValue), TransformSpace.Local);
		}
		void SetupViewport()
		{
